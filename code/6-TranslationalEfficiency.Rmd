...
#want to be able to compare the TE of all genes to those of specific biotypes. The expectation is that lincRNAs will have a lower TE since they are not traditionally translated. 
TEdata2 <- TEdata %>%
