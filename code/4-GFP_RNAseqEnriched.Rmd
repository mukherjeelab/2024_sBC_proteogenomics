...
```{r DEseq2, message=FALSE, warning=FALSE, echo=FALSE}
...
ggsave(plot = GSEAplotGeneSet, filename = here("plots", "Figure1", "GFP_GSEApancreasHallmark.pdf"), device = "pdf", units = "in", width = 6, height = 4, dpi = 320)
```
...
ggsave(plot = GFPB40_barPlot, filename = here::here("plots","Figure1", "Supp_GFP40dep_barplot.pdf"), device = "pdf", units = "in", width = 6, height = 4, dpi = 320)
```
